...
namespace ATM_System
{
    ...
    public partial class Deposit : Form
    {
        ...
        public Deposit(string name, string AccNo, double mone)
        {
            InitializeComponent();
        ...
        {
            double depositMoney = double.Parse(textMoney.Text);
            money = depositMoney + money;
            MessageBox.Show("The money desposited successfully!", "Confirmation", MessageBoxButtons.OK, MessageBoxIcon.Information);
            moneyLabel.Text = money.ToString();
